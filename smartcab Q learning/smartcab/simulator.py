        ...
        if self.log_metrics:
            ...
            if a.learning:
                if self.optimized: # Whether the user is optimizing the parameters and decay functions
                    self.log_filename = os.path.join(abs_path, "logs", "sim_improved-learning.csv")
                    self.table_filename = os.path.join(abs_path, "logs","sim_improved-learning.txt")
                else: 
                    self.log_filename = os.path.join(abs_path, "logs", "sim_true-learning.csv")
                    self.table_filename = os.path.join(abs_path, "logs","sim_true-learning.txt")
